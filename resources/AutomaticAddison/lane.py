...
class Lane:
    ...
    def __init__(self, orig_frame):
        ...
        :param orig_frame: Original stereo_camera_old image (i.e. frame)
        """
    ...
    def calculate_car_position(self, print_to_terminal=False):
        ...
        """
        # Assume the stereo_camera_old is centered in the image.
    ...
    def get_line_markings(self, frame=None):
        ...
        Isolates lane lines.
          ...
          :param frame: The stereo_camera_old frame that contains the lanes we want to detect
