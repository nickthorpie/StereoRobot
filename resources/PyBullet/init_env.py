...
- Initializes stereo_camera_old
    - Writes stereo_camera_old to a shared memory buffer
...
# Write a function that moves stereo_camera_old to the position and orientation, and captures.
def get_cam_image():
